...
<body>
<nav class="navbar navbar-expand-lg" style="background-color: #F6FBF9;">
    <div class="container-fluid">
        <div class="d-flex justify-content-between w-100 align-items-center">
            <!-- Logo -->
            <a class="navbar-brand" href="{{ route('acceuil') }}">
                <img src="{{ asset('images/logo.png') }}" alt="Image de connexion" class="navbar-logo">
            </a>
            <!-- Espace pour le nom de l'utilisateur et bouton de déconnexion -->
            <div class="d-flex align-items-center">
@yield('nav-item')

            @auth('admin')
                <span class="me-3">{{ Auth::guard('admin')->user()->Nom }} {{ Auth::guard('admin')->user()->Prénom }}</span>
            @endauth
            @auth('agent')
                <span class="me-3">{{ Auth::guard('agent')->user()->Nom }} {{ Auth::guard('agent')->user()->Prenom }}</span>
            @endauth
...
<a href="#" class="sidebar-link d-flex align-items-center" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <li class="sidebar-item">
                    <a href="{{ route('acceuil') }}" class="sidebar-link ">
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
            ...
            <li class="sidebar-item">
                    <a href="{{ route('listeagents') }}" class="sidebar-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
</svg>                       <span>Liste des agents</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('camions') }}" class="sidebar-link">
...
</svg>                        <span>Liste des camions</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a href="{{ route('fattente') }}" class="sidebar-link">
...
</svg>                      <span> File d'attente</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('camenregistrés') }}" class="sidebar-link">
...
</svg>                        <span>Camions enregistrés</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('camionsaction') }}" class="sidebar-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-seam-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.01-.003.268-.108a.75.75 0 0 1 .558 0l.269.108.01.003zM10.404 2 4.25 4.461 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339L8 5.961 5.596 5l6.154-2.461z"/>
</svg>                        <span>Camions en action</span>
                    </a>
                </li>
            </ul>
