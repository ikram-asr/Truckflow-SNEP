...
<div class="table-responsive "  style="       
    ...
    <div class="row  d-flex justify-content-right align-items-center ">
        ...
        <div class="col-md-1">
            <a href="{{ route('fileattente') }}" class="btn btn-secondary" style="color: #fff; background: #f44336; border: 0px; cursor: pointer;">Effacer</a>
        </div>
    </div>
</form>
...
<td class="text-center">{{ $camion->created_at ?? '----' }}</td>
                    @endif
