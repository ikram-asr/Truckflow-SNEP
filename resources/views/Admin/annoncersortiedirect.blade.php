...
<div class="container1" style="width: 100%; max-width: 800px; margin: auto; margin-bottom:50px;">
...
@elseif ($camion && is_null($camion->heure_sortie) && !is_null($camion->Numero_Bl))
    <form action="{{ route('annoncersortied') }}" method="POST">
        @csrf
        <!-- Id Passage -->
        <div class="form-group row mb-2">
            <label for="IdPassage" class="col-sm-4 col-form-label text-right">ID Passage :</label>
...
<div class="form-group row mb-2">
            ...
            <div class="col-sm-8">
                ...
                name="Numero_Bl" class="form-control" readonly value="{{ $camion->Numero_Bl }}" required placeholder=" Numero bl">
