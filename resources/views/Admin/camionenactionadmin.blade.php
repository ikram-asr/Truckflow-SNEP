...
@section('nav-item')
<!--<a href="{{ route('pdf2') }}" class="btn btn-light btn-custom" 
  ...
  <path d="M0 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-1v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2H2a2 2 0 0 1-2-2zm2.5 1a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1"/>
   ...
   <form action="{{ route('pdf2') }}" method="GET">
...
<div class="table-responsive "  style="       
    ...
    margin: 10px;      background: #F6FBF9;
            ...
            box-shadow: 0px 4px 10px 1px rgba(0,0,0,0.1);" >
                        <form action="{{ route('filtredatema') }}" method="GET" class="mb-3">
    @csrf
    <div class="row  d-flex justify-content-right align-items-center ">
        ...
        <div class="col-md-1">
            <a href="{{ route('camionsaction') }}" class="btn btn-secondary" style="color: #fff; background: #f44336; border: 0px; cursor: pointer;">Effacer</a>
        </div>
    </div>
</form>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-truck-front-fill" viewBox="0 0 16 16">
  ...
  <div class="btn-group mr-2" role="group" aria-label="First group">
  <form action="{{ route('supprimercamion2', $camion->IdPassage) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce camion ?');">
              @csrf
              @method('DELETE')
