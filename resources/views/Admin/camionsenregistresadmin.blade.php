...
<div class="container1 "  style="       
    ...
    <div class="row  d-flex justify-content-right align-items-center ">
        ...
        <div class="col-md-1">
            <a href="{{ route('camenregistrés') }}" class="btn btn-secondary" style="color: #fff; background: #f44336; border: 0px; cursor: pointer;">Effacer</a>
        </div>
    </div>
</form>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-truck-front-fill" viewBox="0 0 16 16">
  ...
  <div class="btn-group mr-2" role="group" aria-label="First group">
  <form action="{{ route('supprimercamion1', $camion->IdPassage) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce camion ?');">
              @csrf
              @method('DELETE')
