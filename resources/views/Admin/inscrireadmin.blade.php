...
<div class="container1" >
    <h3 style=" font-weight: bold;">Inscrie un nouvel admin</h3>

    <!-- Formulaire d'inscription -->
    <form method="POST" action="{{ route('inscr') }}">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" id="Prénom" name="Prénom" style="font-size: 18px; border: 1px solid #16a085; border-radius: 5px;" class="form-control @error('Prenom') is-invalid @enderror" value="{{ old('Prenom') }}" required placeholder="Votre prénom">
            @error('Prénom')
                <span class="invalid-feedback" role="alert" style="font-family: 'Poppins', sans-serif; font-weight: bold;">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group">
            ...
            <input type="text" id="nom_utilisateur" name="nom_utilisateur" style="font-size: 18px; border: 1px solid #16a085; border-radius: 5px;" class="form-control @error('nomutilisateur') is-invalid @enderror" value="{{ old('nom8utilisateur') }}" required placeholder="Votre nom d'utilisateur">
